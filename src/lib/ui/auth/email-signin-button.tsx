...
export function EmailSigninButton({ label }: { label: string }) {
  return <OutlineButton label={label} icon={<MaterialSymbolsMailOutline />} />;
}

// material-symbols:mail-outline
function MaterialSymbolsMailOutline(props: SVGProps<SVGSVGElement>) {
  return (
